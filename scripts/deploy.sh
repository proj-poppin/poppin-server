...
cd /service/tomcat/deploy
echo "> 복사 시작  " >> /home/ubuntu/deploy.log
BUILD_JAR=$(ls *.jar)
JAR_NAME=$(basename $BUILD_JAR)
echo "> build 파일명: $JAR_NAME" >> /home/ubuntu/deploy.log

echo "> build 파일 복사" >> /home/ubuntu/deploy.log
DEPLOY_PATH=/service/tomcat
...
nohup java -jar $DEPLOY_JAR >> /home/ubuntu/deploy.log 2>/var/log/poppin-server.log &
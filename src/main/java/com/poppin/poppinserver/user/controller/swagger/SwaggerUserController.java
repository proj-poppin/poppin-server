...
//    );
    ...
    ResponseDto<PagingResponseDto<List<PopupStoreDto>>> searchPopupName(
            ...
            @Parameter(example = "market,display,experience") @RequestParam("taste") String taste,
            @Parameter(example = "fashionBeauty,characters,foodBeverage,webtoonAni,interiorThings,movie,musical,sports,game,itTech,kpop,alcohol,animalPlant,etc") @RequestParam("prepered") String prepered,
